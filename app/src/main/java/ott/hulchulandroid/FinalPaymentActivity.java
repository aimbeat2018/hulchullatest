...
import ott.hulchulandroid.adapters.MyListAdapter;
import ott.hulchulandroid.adapters.MyListData;
import ott.hulchulandroid.adapters.PackageAdapter;
...
import ott.hulchulandroid.onepay.Constants;
import ott.hulchulandroid.onepay.PaymentActivity;
...
public class FinalPaymentActivity extends AppCompatActivity {
    ...
    TextView package_name,
            package_validity,
            price;
    CardView card_paytm, card_phonepay,
            card_payuMoney,
        ...
        rec_age.addOnItemTouchListener(
                new PackageAdapter.RecyclerItemClickListener(FinalPaymentActivity.this, rec_age, new PackageAdapter.RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        ott.hulchulandroid.adapters.MyListAdapter.ViewHolder viewHolder = (ott.hulchulandroid.adapters.MyListAdapter.ViewHolder) rec_age.getChildViewHolder(view);
...
*/
        ...
        card_phonepay.setOnClickListener(view -> {
          ...
          //  Intent intent = new Intent(FinalPaymentActivity.this, PhonepayActivity.class);
           // Intent intent = new Intent(FinalPaymentActivity.this, PhonepayActivityLatest.class);
            intent.putExtra("package", aPackage);
            intent.putExtra("currency", "currency");
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if (response.code() == 200) {
                    try {
                        ...
                        String phonepay = jsonObject.getString("phonepay");
...
//                        }
                        ...
                        if (phonepay.equals("1")) {
                            card_phonepay.setVisibility(View.GONE);
                        } else {
                            card_phonepay.setVisibility(View.GONE);
                        }
