...
import ott.hulchulandroid.network.apis.ConfigurationApi;
import ott.hulchulandroid.network.model.config.ApkUpdateInfo;
...
//added splash video
                                    Uri video = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.hulchulvdo);
                                    myvideoview.setVideoURI(video);
