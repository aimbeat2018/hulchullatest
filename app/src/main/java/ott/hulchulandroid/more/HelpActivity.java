package ott.hulchulandroid.more;
...
public class HelpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call_us.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                System.out.println("OnItemClickListener ==> listData ==> " + "8433633179");
                startActivity(intent);
            }
        });
    ...
    private void sendEmail() {
        ...
        String to[] = {"customercare@hulchul.co.in"};
        ...
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Hulchul Customer Query ");
