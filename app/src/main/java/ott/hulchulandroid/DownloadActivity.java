...
import ott.hulchulandroid.adapters.DownloadHistoryAdapter;
import ott.hulchulandroid.adapters.DownloadedVideoListAdapter;
import ott.hulchulandroid.adapters.FileDownloadingAdapter;
import ott.hulchulandroid.constant.AppUtil;
...
import ott.hulchulandroid.nav_fragments.DownloadNewFragment;
...
//                activity.getSupportFragmentManager().beginTransaction().replace(R.id.Container, myFragment).addToBackStack(null).commit();
                ...
                ott.hulchulandroid.database.DatabaseHelper offlineDatabaseHelper1 = new DatabaseHelper(DownloadActivity.this);
