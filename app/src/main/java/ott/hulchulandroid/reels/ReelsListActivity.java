package ott.hulchulandroid.reels;
...
import ott.hulchulandroid.SearchGridAdapter;
import ott.hulchulandroid.SubscriptionActivity;
import ott.hulchulandroid.adapters.InactiveSubscriptionAdapter;
import ott.hulchulandroid.databinding.ActivityReelsListBinding;
import ott.hulchulandroid.databinding.ItemReelsBinding;
import ott.hulchulandroid.firebaseservice.Config;
import ott.hulchulandroid.models.ReelsModel;
import ott.hulchulandroid.network.OnReelsVideoAdapterListner;
import ott.hulchulandroid.network.RetrofitClient;
import ott.hulchulandroid.network.apis.ReelsApi;
...
//        binding.recList.setLayoutManager(new LinearLayoutManager(this));
        ...
        new PagerSnapHelper().attachToRecyclerView(recList);
       ...
       recList.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                    int position = ((LinearLayoutManager) recList.getLayoutManager()).findFirstCompletelyVisibleItemPosition();
                    if (!(position <= -1) && lastPosition != position) {
                        if (recList.getLayoutManager() != null) {
                            View view = recList.getLayoutManager().findViewByPosition(position);
                            if (view != null) {
...
//                    reelsAdapter = new ReelsAdapter();
                  ...
                  recList.setAdapter(reelsAdapter);
