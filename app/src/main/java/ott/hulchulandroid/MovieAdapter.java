...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.OriginalViewHolder> {
    ...
    public MovieAdapter(Context context, List<CommonModels> items) {
        this.items = items;
        ctx = context;
    }
    ...
    @Override
    public MovieAdapter.OriginalViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      MovieAdapter.OriginalViewHolder vh;

        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.trending_card_home_view, parent, false);
        vh = new MovieAdapter.OriginalViewHolder(v);
        return vh;
    }

    @Override
    public void onBindViewHolder(final MovieAdapter.OriginalViewHolder holder, final int position) {
